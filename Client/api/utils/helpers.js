...
class Helpers {
    ...
    execVoidFunInLoopAsync(loopCount, fun, params, callback) {
        var counter = 0;
    ...
    calculateDigest(algorithm, doc, encoding) {
        var digest;
    ...
    calculateMultiDigest(doc, algorithms, callback, loopCount) {
    ...
    hmac(algorithm, key, text, encoding) {
